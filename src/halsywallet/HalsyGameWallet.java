...
public class HalsyGameWallet extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        pembayaran.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Pilih", "OVO / DANA / BNI", "Pulsa XL", "Pulsa TSEL" }));
    ...
    private void text_jumlahKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_text_jumlahKeyReleased
        //Jumlah Pembelian
        int a,b,c;
        a=Integer.valueOf(text_harga.getText());
        b=Integer.valueOf(text_jumlah.getText());
        c=a*b;
    ...
    private void text_bayarKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_text_bayarKeyReleased
        ...
        int a,b,c;
        a=Integer.valueOf(text_bayar.getText());
        b=Integer.valueOf(text_total.getText());
        c=a-b;
